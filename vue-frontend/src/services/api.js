...
export const movApi = {
  ...
  upload: async (file, meta = {}) => {
    ...
    return gasWrite('POST', 'mov/upload', { fileName: file.name, mimeType: file.type, size: file.size, base64, ...meta })
  }
}
...
export default { authApi, dashboardApi, usersApi, kraApi, accomplishmentsApi, movApi, evaluationApi, reportsApi, notificationsApi, auditApi }